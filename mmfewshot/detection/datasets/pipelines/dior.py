...
DIOR_SPLIT = dict(
    ...
    ALL_CLASSES_SPLIT4=('baseballfield', 'basketballcourt', 'bridge','chimney', 'ship',
                        ...
                        'dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle',
                        'Expressway-Service-area', 'overpass', 'stadium', 'trainstation', 'windmill'),
    ALL_CLASSES_SPLIT5=('baseballfield', 'basketballcourt', 'bridge', 'chimney', 'ship',
                        'airplane', 'airport', 'Expressway-toll-station', 'harbor', 'groundtrackfield',
                        'dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle',
                        'Expressway-Service-area', 'overpass', 'stadium', 'trainstation', 'windmill'),
    ...
    NOVEL_CLASSES_SPLIT5=('airplane', 'baseballfield', 'tenniscourt', 'trainstation', 'windmill'),
    ...
    BASE_CLASSES_SPLIT4=('baseballfield', 'basketballcourt', 'bridge','chimney', 'ship',
                        'airplane', 'airport', 'Expressway-toll-station', 'harbor', 'groundtrackfield',
                        'dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle'),
    BASE_CLASSES_SPLIT5=('basketballcourt', 'bridge','chimney', 'ship',
                        'airport', 'Expressway-toll-station', 'harbor', 'groundtrackfield',
                        'dam', 'golffield', 'storagetank', 'vehicle',
...
class FewShotDIORDataset(BaseFewShotDataset):
    ...
    def load_annotations_xml(
        ...
        for img_name in img_names:
            ...
            #xml_path = osp.join(self.img_prefix, dataset_year, Annotation_dir,f'{img_id}.xml')
            xml_path = osp.join(self.img_prefix, Annotation_dir, f'{img_id}.xml')
            ...
            if size is not None:
                ...
                #img_path = osp.join(self.img_prefix, dataset_year, JPEGImages_dir, '{}.jpg'.format(img_id))
                img_path = osp.join(self.img_prefix, JPEGImages_dir, '{}.jpg'.format(img_id))
